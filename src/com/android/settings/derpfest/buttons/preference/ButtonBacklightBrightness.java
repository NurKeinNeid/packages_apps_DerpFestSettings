...
package com.android.settings.derpfest.buttons.preference;
...
public class ButtonBacklightBrightness extends CustomDialogPreference<AlertDialog> implements
    ...
    public ButtonBacklightBrightness(Context context, AttributeSet attrs) {
        ...
        if (DeviceUtils.hasKeyboardBacklightSupport(context)) {
            ...
            mKeyboardBrightness = new BrightnessControl(
                    DerpFestSettings.Secure.KEYBOARD_BRIGHTNESS, isSingleValue);
    ...
    private int getTimeout() {
        return Settings.Secure.getInt(mResolver,
                DerpFestSettings.Secure.BUTTON_BACKLIGHT_TIMEOUT, DEFAULT_BUTTON_TIMEOUT * 1000)
                / 1000;
    }

    private void applyTimeout(int timeout) {
        Settings.Secure.putInt(mResolver,
                DerpFestSettings.Secure.BUTTON_BACKLIGHT_TIMEOUT, timeout * 1000);
    }
