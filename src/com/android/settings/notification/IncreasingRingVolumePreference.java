...
public class IncreasingRingVolumePreference extends Preference
    ...
    public void onBindViewHolder(PreferenceViewHolder holder) {
        ...
        int rampUpTime = Settings.System.getInt(cr,
                DerpFestSettings.System.INCREASING_RING_RAMP_UP_TIME, 10);
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromTouch) {
        ...
        if (fromTouch && seekBar == mStartVolumeSeekBar) {
            Settings.System.putFloat(cr,
                    DerpFestSettings.System.INCREASING_RING_START_VOLUME, (float) progress / 1000F);
            ...
            if (fromTouch) {
                Settings.System.putInt(cr,
                        DerpFestSettings.System.INCREASING_RING_RAMP_UP_TIME, seconds);
            }
        }
    }
