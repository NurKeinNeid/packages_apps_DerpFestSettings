...
public class SwipeToScreenshotPreferenceController extends GesturePreferenceController {
    ...
    public boolean setChecked(boolean isChecked) {
        return Settings.System.putInt(mContext.getContentResolver(), DerpFestSettings.System.THREE_FINGER_GESTURE,
                isChecked ? ON : OFF);
    }

    @Override
    public boolean isChecked() {
        return Settings.System.getInt(mContext.getContentResolver(), DerpFestSettings.System.THREE_FINGER_GESTURE, 0) != 0;
    }
}
